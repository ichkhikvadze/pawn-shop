...
public class MaterialExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMaterialNotFoundException(MaterialNotFoundException exception,
                                                                  WebRequest request) {
        return handleExceptionInternal(exception, exception.getMessage(), new HttpHeaders(), HttpStatus.NOT_FOUND, request);
    }

    @ExceptionHandler(MaterialAlreadyExistsException.class)
    public ResponseEntity<Object> handleMaterialAlreadyExistsException(MaterialAlreadyExistsException exception,
                                                                       WebRequest request) {
